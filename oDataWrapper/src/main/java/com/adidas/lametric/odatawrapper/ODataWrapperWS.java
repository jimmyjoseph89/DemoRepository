...
/*Copyright (C) 2018 adidas AG. */
package com.adidas.lametric.odatawrapper;
...
/**
ODataWrapperWS is a class for wrapping oData in 
order to provide the data in accordance to 
...
public class ODataWrapperWS {
	...
	public String getCount() throws IOException, ODataException {
